...
// ---------------------------------------------------------------------------
// Model marks for "built on" — the real brand glyphs, monochrome.
// Sources: Cursor / Claude / OpenAI from Simple Icons (CC0); Zhipu / Kimi /
// Fireworks from the lobehub icon set. All normalized to a 24×24 viewBox and
// drawn with currentColor so they tint with the site palette.
// ---------------------------------------------------------------------------
...
// Cursor — the model "Composer" runs here
...
// Z.ai — GLM
export const IconZai = (p) => (
  <svg {...brand} viewBox="0 0 30 30" {...p}>
...
// Kimi — KIMI
export const IconKimi = (p) => (
  <svg {...brand} fillRule="evenodd" {...p}>
...
export const IconFireworks = (p) => (
  <svg {...brand} fillRule="evenodd" clipRule="evenodd" {...p}>
